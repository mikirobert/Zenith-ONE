...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Inainte",sPrevious:"Inapoi"},sEmptyTable:"No data available in table",sInfo:"Se afiseaza de la _START_ pana la _END_ din _TOTAL_ angajati",sInfoEmpty:"Se afiseaza de la 0 la 0 din 0 angajati",
sInfoFiltered:"(filtrat din _MAX_ angajati totali)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afiseaza _MENU_ angajati",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cauta:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nu a fost gasit niciun angajat"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
